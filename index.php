...
<html lang="en">
    ...
    <body>
        ...
        <section id="home" class="banner" data-scroll-index="0">
            ...
            <div class="container">
                ...
                <div class="banner-caption">
                    <h1>Hi! I'm Sreejith.</h1>
                    <p class="cd-headline clip mt-30">
                        <span>Creative Designer & Developer located in Trivandram.</span><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        ...
                        <div class="about-content">
                            ...
                            <p>I'm <b>Sreejith v</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to specimen book.</p>
        ...
        <!--Blog Section End-->
                <div class="container">
                    <div class="row col-lg-12 " style="display: flex; flex-direction: column; align-items: center;">
                    
                      <video autoplay="" loop="" muted="" preload="true" volume="0" style="margin-top: 2em; margin-bottom: 2em;">

                            <source src="images/small.mp4" type="video/mp4"> 

                            <source src="images/small.ogv" type="video/ogg">                             
                        </video>
            ...
            <div class="container">
                <div class="row text-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="contact-info">
                            <h5>Address</h5>
                            <p>Sreemandiram,kallarathala,kunnathukal(PO) pin:695504,TVM,Kerala</p>
                        </div>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-md-12">
                        <hr>
                        <p class="copy pt-30">
                            Sreejith &copy; 2019. All Right Reserved, Designed By SRV-Creations.
                        </p>
                    </div>
                </div>
            </div>
